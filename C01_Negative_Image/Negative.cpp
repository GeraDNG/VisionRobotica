...
void userdefined ()
{
	//Declare pixel as an unsigned char to have values from 0 to 255:
	unsigned char Pixel;
	...
	do {
		//Save negative Pixel on output image:
		fputc(~Pixel,outfptr); // ~Pixel will be the same as 255-Pixel
